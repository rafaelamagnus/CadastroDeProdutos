...
abstract class ICheckUserUsecase {
...
class CheckUserUsecase implements ICheckUserUsecase {
  ...
  @override
  Future<Either<IAuthenticateErrors, UserEntity>> call(UserEnviarEntity userEnviarEntity) =>_repository.checkUser(userEnviarEntity);
}